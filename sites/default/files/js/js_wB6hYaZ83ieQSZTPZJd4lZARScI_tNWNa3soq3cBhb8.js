...
// Send filter request on change event of exposed filters

jQuery('body').on('change','#edit-field-posting-date-value', (function(e){
        console.log(jQuery(e.target).closest('form').find('input[type="submit"]').click());
}));
